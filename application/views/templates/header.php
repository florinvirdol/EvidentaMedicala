...
//                                console.log(this);
                    ...
                    function adauga_medicament_compensat_element()
                    {
                        ...
                        $("#medicamente_compensate").append(
                            '<fieldset id="info_medicament_' + contor_med + '">' +
                                '<legend>Medicament ' + contor_med + '</legend>' +
                                '<label for="medicament_' + contor_med + '_international">Nume Interna?ional</label>' +
                                '<input type="text" name="medicament_' + contor_med + '_international">' +
                                '<label for="medicament_' + contor_med + '_comercial">Nume Comercial</label>' +
                                '<input type="text" name="medicament_' + contor_med + '_comercial">' +
                                '<br>' +
                                '<label for="medicament_' + contor_med + '_valoare_amanunt">Valoare Amanunt</label>' +
                                '<input type="text" name="medicament_' + contor_med + '_valoare_amanunt">' +
                                '<label for="medicament_' + contor_med + '_valoare_compensat">Valoare Compensat</label>' +
                                '<input type="text" name="medicament_' + contor_med + '_valoare_compensat">' +
                                '<br>' +
                            '</fieldset>'
                        );
                    ...
                    function adauga_medicament_element()
                    {
                        ...
                        $("#medicamente_necompensate").append(
                            '<fieldset id="info_medicament_' + contor_med + '">' +
                                ...
                                '<label for="medicament_' + contor_med + '_comercial">Nume Comercial</label>' +
                                '<input type="text" name="medicament_' + contor_med + '_comercial">' +
                                '<label for="medicament_' + contor_med + '_valoare">Valoare</label>' +
                                '<input type="text" name="medicament_' + contor_med + '_valoare">' +
                                '<br>' +
                            '</fieldset>'
                        );
                    }
